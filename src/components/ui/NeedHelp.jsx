...
export default function NeedHelp({ className = '' }) {
  return (
    <section className={`rounded-2xl bg-[#eaf1fe] p-5 sm:p-6 ${className}`}>
      ...
      <p className="mt-1 text-[14px] text-ink-600">{membershipHelp.body}</p>
      ...
      <div className="mt-5 flex flex-wrap gap-3">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2.5 rounded-xl bg-white px-5 py-3.5 text-[14px] font-bold uppercase tracking-wide text-ink-900 shadow-card transition hover:bg-surface-soft"
        >
